...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        performSelector(inBackground: #selector(loadDataFromTheFile), with: nil)
    ...
    @objc func loadDataFromTheFile(){
        ...
        // here we are in background thread so we aren't supposed to access UI in here so the next line to access the UI from the main thread
